...
class LoginResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('lgpdPendente')) {
                obj['lgpdPendente'] = ApiClient.convertToType(data['lgpdPendente'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 */
LoginResponse.prototype['perfil'] = undefined;

/**
 * @member {Boolean} lgpdPendente
 */
LoginResponse.prototype['lgpdPendente'] = undefined;
